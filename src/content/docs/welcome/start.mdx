...
<Aside>
  This course was a side-product of my exploratory work on a compiler for Gom. You can explore the code in the link below, I refer to parts of the compiler code in many chapters.

[gom-lang/gom](https://github.com/gom-lang/gom)
